Racetipper::Application.routes.draw do
	...
	get 'admin/manage_stages'
	get 'admin/edit_stage'
	get 'admin/manage_races'
	get 'admin/edit_race'
	get 'admin/manage_season_teams'
	get 'admin/edit_season_team'
	get 'admin/manage_season_stages'
	post 'admin/login'
	post 'admin/save_riders'
	post 'admin/save_stages'
	post 'admin/save_races'
	post 'admin/save_season_teams'
	post 'admin/save_season_stages'
	match 'admin/edit_season/:id' => 'admin#edit_season'
	match 'admin/edit_rider/:id' => 'admin#edit_rider'
	match 'admin/edit_stage/:id' => 'admin#edit_stage'
	match 'admin/edit_race/:id' => 'admin#edit_race'
